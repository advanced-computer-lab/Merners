...
function Changesumm() {
    ...
    const axiosparams = {"params":{"_id":id.flight_id, "class":id.class, "seats":id.seats}};
    ...
    const [newres, setnewres] = useState({ _id: id.reservation_id, flight: id.flight_id, user: id.user_id, adultsNumber:id.adultsNumber, childrenNumber:id.childrenNumber, totalPrice:"", classChoosen: id.class, seatsChoosen: id.seats});
    ...
    const  HandleSubmit = (e) => {
        e.preventDefault();
         ...
         const wrse={resid:id.reservation_id,nfi:id.flight_id,seats:id.seats,class:id.class};
       ...
       axios.post('http://localhost:8000/reservations/update', newres).then(() => console.log("posted sucsessfully")).catch((err) => {console.log(err)});
