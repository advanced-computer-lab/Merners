...
function ShowDetailsChange() {
        ...
        if(Class.key === ""){
            ...
            if(Class.key === "First class"){
                if(tnop>flight.firstSeatsAvailable){
                    ...
                    window.location.href = "http://localhost:3000/editSeats/"+params.params.flight_id+"/"+Class.key+"/"+adults+"/"+children+"/"+userparams.params._id+"/"+reservationparams._id+"/"+params.params.desiredFlight_id;
                }
    ...
    useEffect(() => {
        ...
        if(reservation.flight.includes(id.desiredFlight_id)){
