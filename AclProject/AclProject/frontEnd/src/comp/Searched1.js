...
function Searched1() {
    const [flight, setflight] = useState({ flightNumber: "", departureTime: "", arrivalTime: "", departureDate: "", arrivalDate: "", firstSeatsAvailable: "", economySeatsAvailable: "", businessSeatsAvailable: "", airport: "", from: "", to: "" });
    const HandleSubmit = () => {
        alert("lollllll");
    ...
    return (
        <div>
            ...
            <form onSubmit={() => {
                ...
                <label> firstSeatsAvailable : </label><br />
                <input type="text" id="firstSeatsAvailable" name="firstSeatsAvailable" value={flight.firstSeatsAvailable} onChange={(e) => { setflight({ ...flight, firstSeatsAvailable: e.target.value }) }} required></input><br /><br />

                <label> Economy seats available: </label><br />
